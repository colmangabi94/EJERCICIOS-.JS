...
function compareTenAndNine(): {
    //Tu codigo aqui
    console.log(10>=9);   // Imprime el resultado en consola
}
...
function compareZeroAndZero(): {
  //Tu codigo aqui
  console.log(0==0);   // Imprime el resultado en consola
...
function createMessageVariable(): {
    const  mensaje = "Hola JavaScript"; // Crea una variable llamada `mensaje`
...
function logAge():  {
 let edad = 30; // Crea una variable llamada `edad`
 console.log(edad); // Imprime el valor de la variable en la consola
